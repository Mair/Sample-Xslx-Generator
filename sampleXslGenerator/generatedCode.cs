...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            OpenXmlUnknownElement openXmlUnknownElement1 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<x15ac:absPath xmlns:x15ac=\"http://schemas.microsoft.com/office/spreadsheetml/2010/11/ac\" url=\"C:\\Users\\mswartz\\Desktop\\\" />");
            ...
            WorkbookView workbookView1 = new WorkbookView() { XWindow = 0, YWindow = 0, WindowWidth = (UInt32Value)24000U, WindowHeight = (UInt32Value)9735U };
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            CellFormat cellFormat4 = new CellFormat() { NumberFormatId = (UInt32Value)2U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true };
            ...
            NumberingFormat numberingFormat1 = new NumberingFormat() { NumberFormatId = (UInt32Value)2U, FormatCode = "0.00" };

            differentialFormat1.Append(numberingFormat1);

            DifferentialFormat differentialFormat2 = new DifferentialFormat();
            NumberingFormat numberingFormat2 = new NumberingFormat() { NumberFormatId = (UInt32Value)19U, FormatCode = "dd/mm/yy" };
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1)
        {
            ...
            SheetDimension sheetDimension1 = new SheetDimension() { Reference = "A1:D1" };

            SheetViews sheetViews1 = new SheetViews();

            SheetView sheetView1 = new SheetView() { TabSelected = true, WorkbookViewId = (UInt32Value)0U };
            Selection selection1 = new Selection() { ActiveCell = "D1", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "D1:D1048576" } };
            ...
            Column column2 = new Column() { Min = (UInt32Value)2U, Max = (UInt32Value)2U, Width = 11.5703125D, CustomWidth = true };
            Column column3 = new Column() { Min = (UInt32Value)3U, Max = (UInt32Value)3U, Width = 14.28515625D, Style = (UInt32Value)1U, CustomWidth = true };
            Column column4 = new Column() { Min = (UInt32Value)4U, Max = (UInt32Value)4U, Width = 9.85546875D, Style = (UInt32Value)2U, CustomWidth = true };
            ...
            PageSetup pageSetup1 = new PageSetup() { PaperSize = (UInt32Value)9U, Orientation = OrientationValues.Portrait, HorizontalDpi = (UInt32Value)90U, VerticalDpi = (UInt32Value)90U, Id = "rId1" };
        ...
        {
            Table table1 = new Table() { Id = (UInt32Value)1U, Name = "Table1", DisplayName = "Table1", Reference = "A1:D1048576", TotalsRowShown = false };
            AutoFilter autoFilter1 = new AutoFilter() { Reference = "A1:D1048576" };

            TableColumns tableColumns1 = new TableColumns() { Count = (UInt32Value)4U };
            TableColumn tableColumn1 = new TableColumn() { Id = (UInt32Value)1U, Name = "Firstname" };
            TableColumn tableColumn2 = new TableColumn() { Id = (UInt32Value)2U, Name = "Lastname" };
            TableColumn tableColumn3 = new TableColumn() { Id = (UInt32Value)3U, Name = "Date of birth", DataFormatId = (UInt32Value)1U };
            TableColumn tableColumn4 = new TableColumn() { Id = (UInt32Value)4U, Name = "Age", DataFormatId = (UInt32Value)0U };
        ...
        {
            document.PackageProperties.Creator = "Mair Swartz (AU)";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2014-09-07T04:18:21Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2014-09-07T04:27:17Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Mair Swartz (AU)";
        }

        #region Binary Data
        private string spreadsheetPrinterSettingsPart1Data = "";
